      ...
      >
        <CardContent className="p-6 space-y-5">
          <div className="flex items-center justify-between">
            <h3 className="font-heading text-xl font-bold text-white">Rate your experience</h3>
            <button onClick={onClose} aria-label="Close" className="text-muted-foreground hover:text-white">
              <X className="h-5 w-5" />
            </button>
          </div>
          ...
          {existing ? (
            ...
            <>
              ...
              {showVendor && (
                <div>
                  <p className="text-sm font-semibold text-white mb-2">The merchant</p>
